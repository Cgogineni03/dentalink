...
import database
from gui.styles import get_effective_theme_name
...
class DentalChartWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.lbl_dmft.setFont(QFont("Ubuntu", 11, QFont.Weight.Bold))
    ...
    def paint_chart_view(self, event, canvas):
        ...
        # Theme-aware colors
        effective_theme = get_effective_theme_name(self.theme_name)
        if effective_theme == "light":
        ...
        font_label = QFont("Ubuntu", 8, QFont.Weight.Bold)
        font_title = QFont("Ubuntu", 9, QFont.Weight.Bold)
