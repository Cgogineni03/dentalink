...
class DentaLinkMainWindow(QMainWindow):
    def __init__(self, doctor_session=None):
        ...
        # Real-time system theme monitor
        try:
    ...
    def update_clinic_logo(self):
        ...
        if logo_path and os.path.exists(logo_path):
            ...
            self.logo_lbl.setFont(QFont("Ubuntu", 18, QFont.Weight.Bold))
    ...
    def init_case_file_view(self):
        ...
        self.banner_title.setFont(QFont("Ubuntu", 11, QFont.Weight.Bold))
        ...
        self.lbl_case_record_no.setFont(QFont("Ubuntu", 10, QFont.Weight.Bold))
    ...
    def render_report_paint(self, printer):
        ...
        <head>
        <style>
            body {{ font-family: 'Ubuntu', 'Cantarell', 'Inter', sans-serif; color: #000000; margin: 15px; font-size: 13pt; line-height: 1.4; }}
            table.letterhead-tbl {{ width: 100%; border-collapse: collapse; margin-bottom: 8px; }}
            .clinic-name {{ font-size: 20pt; font-weight: bold; color: #0f172a; font-family: 'Ubuntu', 'Cantarell', 'Inter', sans-serif; letter-spacing: 0.5px; }}
        ...
        <body>
            ...
            <div style="border: 2px solid #64748b; border-radius: 8px; padding: 16px; margin-top: 20px; background-color: #ffffff;">
                <div style="text-align: center; font-size: 20pt; font-weight: bold; margin-bottom: 14px; font-family: 'Ubuntu', 'Cantarell', 'Inter', sans-serif;">
    ...
    def init_settings_view(self):
        ...
        self.theme_combo.addItems(["System (Auto)", "Dark Theme", "Light Theme"])
        ...
        if current_theme == "light":
            ...
            self.theme_combo.setCurrentText("System (Auto)")
