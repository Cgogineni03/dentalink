...
class FirstLaunchSetupDialog(QDialog):
    ...
    def __init__(self, start_step=1, parent=None):
        ...
        self.lbl_header_title.setFont(QFont("Arial", 15, QFont.Weight.Bold))
        ...
        self.lbl_step1_ind.setFont(QFont("Arial", 10, QFont.Weight.Bold))
        ...
        self.lbl_step2_ind.setFont(QFont("Arial", 10, QFont.Weight.Bold))
